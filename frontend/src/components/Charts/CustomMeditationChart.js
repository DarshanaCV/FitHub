...
const CustomMeditationChart = () => {
    ...
    useEffect(() => {
        const fetchData = () => {
            ...
            const userRef = ref(database, `/users/${userId}/customMeditationBestTime`);
    ...
    return (
        <div className='custom-meditation-container'>
...
export default CustomMeditationChart;
